        ...
        <div className="app">
            ...
            <div className='main-dayz'>
                <div className='dayz-rules'>
                    <h1 className='dayz-h1'>Правила DayZ</h1>
                        <p className='dayz-p'>1. Действия в игре<br/>Нарушение правил сервера может быть наказуемо: Предупреждением, баном на сервере на определённый срок или изьятием игровых предметов или валюты</p> 
                        <p className='dayz-p'>1.1. Обман при обмене предметов<br/>Запрещено обманывать игроков во время обменов при присутствии модератора. В том числе:Запрещено вводить в заблуждение неясными формулировками условий.Запрещено убивать Модератора, проводящего обмен, до тех пор, пока он не покинет место проведения обмена.<br/><span className="mark">Наказание</span>— бан и/или конфискация украденных предметов</p> 
                        <p className='dayz-p'>1.2. Помеха обмену<br/>Запрещено мешать проведению обмена и/или воровать игровые предметы, которые участвуют непосредственно в этом обмене.<br/><span className='mark'>Наказание</span> — бан и/или конфискация украденных предметов</p>
                        <p className='dayz-p'>1.3. Телепортация<br/>Запрещено наносить другому игроку какой-либо ущерб при телепортации:Запрещено телепортировать игроков в стены или другие места, в которых нанесения урона от удушья неизбежно.Игрок обязан телепортировать другого игрока на сейвзону, если он подтвердил, что находится на её территории.<br/><span className='mark'>Наказание</span> — бан</p>
                        <p className='dayz-p'>2. Запрещенный скин<br/>Запрещены скины, повторяющие внутриигровую броню или одежду, содержащие изображения сексуального характера, наркотиков, нацистской символики, личной информации других пользователей, оскорбления.<br/><span className='mark'>Наказание</span> — бан </p>
                        <p className='dayz-p'>3. Оскорбления в чате <br/>Запрещено оскорблять родственников либо самого игрока в чате.<br/><span className="mark">Наказание</span> — мут на 2 часа</p>
                </div>            
            </div>
        </div>
    )
